...
class __TwigTemplate_c45481217320d6bcb027cf0ea7c667ca extends Template
{
...
($context["required"] ?? null)) ? ("required") : ("")), "form-element", "form-element--type-textarea", "form-element--api-textarea"];
        // line 26
        yield "<div";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["wrapper_attributes"] ?? null), "addClass", ["form-textarea-wrapper"], "method", false, false, true, 26), 26, $this->source), "html", null, true);
        yield ">
  <textarea";
        // line 27
        ...
        yield ">";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["value"] ?? null), 27, $this->source), "html", null, true);
        yield "</textarea>
</div>
";
    ...
    {
        return new Source("", "core/themes/claro/templates/form/textarea.html.twig", "C:\\xampp\\htdocs\\final_pio\\web\\core\\themes\\claro\\templates\\form\\textarea.html.twig");
    }
